...
const SLASH_COMMANDS: SlashCommand[] = [
  { command: "/status", description: "Lihat status session + usage ringkas" },
  { command: "/usage", description: "Lihat statistik pemakaian token" },
  { command: "/reasoning", description: "Toggle mode reasoning" },
  { command: "/model", description: "Cek/ubah model aktif" },
