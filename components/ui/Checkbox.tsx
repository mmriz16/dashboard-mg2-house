  ...
  return (
    <label className="inline-flex items-center gap-2.5 cursor-pointer group">
      <div className="relative flex items-center justify-center">
        <input
          type="checkbox"
          className="peer appearance-none w-5 h-5 bg-[#151618] border border-white/10 rounded-md checked:bg-purple-600 checked:border-purple-600 transition-all cursor-pointer"
          {...props}
        />
        <svg 
