...
const AGENT_DISPLAY_NAME = "Openclaw AgentðŸ¦ž";
const STAR_COLORS = [
  "#dbeafe",
  "#bfdbfe",
  "#93c5fd",
  ...
  const handleSendMessage = async (content: string) => {
    ...
    try {
      const persistedConversationKey =
        persistConversationKeyRef.current &&
          persistConversationKeyRef.current !== DRAFT_CHAT_KEY
          ? persistConversationKeyRef.current
          : "";

      let effectiveConversationKey = activeConversationKey || persistedConversationKey;
